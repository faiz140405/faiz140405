...
```python
class FaizNizarNuaim:
    def __init__(self):
        self.name       = "Faiz Nizar Nu'aim"
        self.university = "Universitas Teknokrat Indonesia"
        self.major      = "Teknik Informatika"
        self.location   = "Indonesia 🇮🇩"
        self.interests  = ["Software Development", "Embedded Systems", "AI/ML"]
        self.languages  = ["Python", "PHP", "Node.js", "C", "C++"]
        self.open_to    = "Kolaborasi & Proyek Menarik 🤝"
 
    def say_hi(self):
        print("Selamat datang di profil saya! Yuk berkolaborasi!")
...
- 🤖 **Machine Learning & AI** — Mengeksplorasi model prediktif dan deep learning
- 🌐 **RESTful API Development** — Membangun backend yang skalabel dengan Node.js & Django
- 🔌 **Embedded Systems** — Proyek IoT dengan mikrokontroler
- ☁️ **Cloud & DevOps** — Belajar deployment modern
---
...
[![Email](https://img.shields.io/badge/Kirim_Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:cahmargablok51@gmail.com)
